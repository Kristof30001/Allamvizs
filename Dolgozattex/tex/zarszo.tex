...
A javasolt konfiguráció és a megtérülés a háztartás méretével skálázódik. Egy kisebb, három fő alatti háztartásnál már egy minimális, vezérlőből és okos konnektorokból álló rendszer is értelmes lehet: néhány száz RON-os beruházás mellett elsősorban a terheléseltolás, például a mosógép olcsóbb időszakra ütemezése hoz megtakarítást, amely jellemzően egy-két éven belül megtérül. A közepes, három--öt fős háztartásoknál a vezérlő mellé 3--5 kWp napelem és 5--10 kWh tároló kiépítése javasolt, ahol az akkumulátor szerepe a saját termelés kihasználásában válik kulcsfontosságúvá, és a beruházás támogatással jellemzően néhány év alatt megtérül. A nagyobb, öt fő feletti háztartásoknál a teljes, nagyobb napelemes és tárolós rendszer a napon belüli áringadozás kihasználását is lehetővé teszi. A telepítés célszerű sorrendje minden esetben a vezérlés és az adatgyűjtés, majd a napelem, végül a tárolás kiépítése, mert így a beruházási kockázat fokozatosan, a tapasztalatok birtokában vállalható.

\section{További fejlesztési irányok}
A jelenlegi modell több irányban is továbbfejleszthető, és ezek a lépések egyúttal az eredmények tudományos megalapozottságát is erősítenék. A legközvetlenebb feladat magának a kiértékelésnek a megerősítése: a jelenlegi, profilonként öt futás helyett algoritmusonként és profilonként legalább tíz-húsz ismétlés, valamint az ezekre épülő konfidencia-intervallumok használata megbízhatóbbá tenné az összehasonlítást, és csökkentené az egy-egy szerencsés vagy kedvezőtlen seed torzító hatását. Ehhez kapcsolódóan érdemes volna egy egységes alapvonalat, akkumulátor és ütemezés nélküli esetet, valamint rögzített tanuló- és validációs naplistát is definiálni.

A modell oldaláról a célfüggvény tovább finomítható: a jelenlegi költségmodell már tartalmaz egy lineáris akkumulátor-degradációs tagot, ezt azonban egy realisztikusabb, a kisütési mélységtől és a töltöttségi szinttől függő, nemlineáris kopásmodell válthatná fel; a visszatáplálási árat pedig egyszerűsített szorzóval kezeli, amelyet pontosabb, idő- és szabályozásfüggő elszámolás finomíthatna. Tartalmi irányban a vizsgálat kiterjeszthető több, egymástól eltérő profilú háztartásra és speciális fogyasztókra, például hőszivattyúra vagy elektromos jármű töltésére, valamint hosszabb, akár éves, megszakítás nélküli időhorizontra.
