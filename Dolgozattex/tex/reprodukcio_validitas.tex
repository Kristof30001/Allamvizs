...
A külső validitás a jelenlegi fázisban kifejezetten magas, mivel a projekt teljesítette az eredetileg javasolt komplexitási szinteket:
\begin{itemize}
  \item a PV adatok valós Huawei inverter-mérésekből származnak,
  \item az árprofilok valós ENTSO-E day-ahead forrásból jönnek (romániai zóna),
  \item a háztartási terhelés pedig a standard UCI Machine Learning Repository okosóra adatsorából (perces felbontásból órásra aggregálva) származik.
\end{itemize}

A gyakorlati általánosíthatóság további javításához a jövőben már csak a következő pontok bevonása szükséges:
\begin{enumerate}
  \item több, egymástól eltérő profilú háztartás és speciális fogyasztók (pl. hőszivattyú, EV) párhuzamos vizsgálata,
  \item hosszabb időhorizontú, megszakítás nélküli éves szimuláció futtatása.
\end{enumerate}

\section{Fenyegetések az érvényességre (threats to validity)}
A benchmark értelmezésénél három fő kockázati csoportot kell figyelembe venni:
\begin{description}
  \item[Adatminőségi kockázatok:] Időbélyeg-inkonzisztencia, hiányos órák vagy forrásoldali formátumváltás torzíthatják a napi profilképzést. A fallback logika csökkenti a futásmegszakadás esélyét, de elemzési torzítást okozhat, ha túl gyakran aktiválódik.
  \item[Modellezési egyszerűsítések:] A jelen célfüggvény még nem tartalmaz explicit akkumulátor-degradációs költséget, és a visszatáplálási ár egyszerűsített szorzóval modellezett. Ezek érdemi közelítések, de korlátozzák a gazdasági becslések pontosságát.
  \item[Algoritmikus torzítások:] Kis futásszám mellett egy-egy szerencsés vagy kedvezőtlen seed túlreprezentálódhat. Ezért a jövőbeli, végleges összehasonlításban a futásszám növelése és bootstrap-alapú konfidencia-intervallumok alkalmazása ajánlott.
\end{description}
